                                ...
                                <div class="callout rounded-0 shadow">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="assigned_to" id="assigned_to" class="form-control form-control-sm form-control-border select2" >
                                            ...
                                            <?php 
                                            $user = $conn->query("SELECT *,CONCAT(lastname, ', ', firstname, ' ', COALESCE(middlename,'')) as fullname 
                                            FROM `users` order by CONCAT(lastname, ', ', firstname, ' ', COALESCE(middlename,'')) asc ");
                                            while($row = $user->fetch_assoc()):
                                            ?>
                                            <option value="<?= $row['id'] ?>" <?= isset($assigned_to) && $assigned_to == $row['id'] ? 
