	...
	<div class="card-header">
		...
		<?php if($_settings->userdata('type') == 1): ?>
			<div>
				...
				<a href="./?page=leads/manage_lead" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus">
				</span>Add New Leads </a>
				</div>
				<div class="card-tools">
				<a href="./?page=leads/upld_cntnt" class="btn btn-sm btn-rght-mrgn"><span class="fas btn-rght-mrgn">
				</span>Upload Leads </a>
				</div>

				<div class="card-tools">
				<a href="./?page=leads/xprt_cntnt" class="btn btn-sm btn-rght-mrgn"><span class="fas btn-rght-mrgn">
				</span>Export data </a>
				</div>
